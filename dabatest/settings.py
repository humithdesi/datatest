"""
Django settings for dabatest project.
...
SECRET_KEY = 'django-insecure-g^t5)_9z)w1qtah86y+k26fj5_8_dlb!ra_c)#dtfl-7t@j_h6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DEBUG")=='1'
ALLOWED_HOSTS = ['3.87.202.47','www.bedlinhpq.tk','bedlinhpq.tk','*']
...
WSGI_APPLICATION = 'dabatest.wsgi.application'
